...
namespace WebQLNS_VTH.Controllers
{
    public class TaiKhoansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "maTK,tenDangNhap,matKhau,loaiTK,maNV")] TaiKhoan taiKhoan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "maTK,tenDangNhap,matKhau,loaiTK,maNV")] TaiKhoan taiKhoan)
        {
            if (ModelState.IsValid)
            {
